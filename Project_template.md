...
![Тесты](testsResult.png)![Kafka topics](kafkaTopics.png)
...
![скриншот вывода при вызове](image.png)
![скриншот вывода event-service после вызова тестов](image-2.png)
...
![скрин вывода](image-3.png)
![скрин развертывания хелма](image-4.png)
